...
public class PagedResponseCompteTest {
    ...
    void testDeserializationPagedResponseWithCompteRepresentation() throws Exception {
        ...
        assertThat(data.get(0).getType()).isEqualTo("CACC");
        assertThat(data.get(0).getStatut()).isEqualTo("OUVERT");
        ...
        assertThat(data.get(1).getType()).isEqualTo("SVGS");
        assertThat(data.get(1).getStatut()).isEqualTo("OUVERT");
        ...
        assertThat(data.get(2).getType()).isEqualTo("CACC");
        assertThat(data.get(2).getStatut()).isEqualTo("BLOQUE");
