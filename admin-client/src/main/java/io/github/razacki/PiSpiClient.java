...
public class PiSpiClient implements AutoCloseable {
    ...
    private static ResteasyClientProvider createDefaultResteasyClientProvider() {
        try {
            return (ResteasyClientProvider) PiSpiClient.class.getClassLoader().loadClass("io.github.razacki.provider.ResteasyClientDefaultProvider").getDeclaredConstructor().newInstance();
