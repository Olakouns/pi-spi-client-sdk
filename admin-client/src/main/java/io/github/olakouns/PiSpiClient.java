...
import io.github.olakouns.filter.PiSpiClientResponseFilter;
import io.github.olakouns.provider.ResteasyClientProvider;
import io.github.olakouns.resource.ApiResource;
import io.github.olakouns.resource.wrapper.ApiResourceWrapper;
...
public class PiSpiClient implements AutoCloseable {
    ...
    private static ResteasyClientProvider createDefaultResteasyClientProvider() {
        try {
            return (ResteasyClientProvider) PiSpiClient.class.getClassLoader().loadClass("io.github.olakouns.provider.ResteasyClientDefaultProvider").getDeclaredConstructor().newInstance();
